    ...
    return (
      <div style={{
        ...
        <div className="glass-card" style={{
          ...
          <h2 style={{ color: '#1a2734', fontSize: 26, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 8 }}>
            {t('success.title')}
          </h2>
          ...
          <button
            ...
            style={{
              ...
              background: '#3d8b85', color: '#fff', fontWeight: 600, fontSize: 16,
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 500, fontSize: 15, border: '1px solid rgba(0,0,0,0.08)', cursor: 'pointer',
            }}
          >
            {t('success.back')}
          </button>
    ...
    <div style={{
      ...
      <div className="glass-card" style={{
        ...
        <div style={{ padding: '24px 24px 20px' }}>
          ...
          {step === 1 && (
            <>
              <h2 style={{ color: '#1a2734', fontSize: 26, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 6 }}>{t('form.step1')}</h2>
                ...
                {NEED_OPTIONS.map(({ type, emoji, key }) => {
                  ...
                  return (
                    <button key={type} onClick={() => toggleNeed(type)} style={{
                      height: 84, borderRadius: 16, display: 'flex', flexDirection: 'column',
                      ...
                      <span style={{ fontSize: 14, fontWeight: 500, color: sel ? '#3d8b85' : '#4b5563' }}>
                        {t(key)}
                      </span>
                    </button>
                  )
          ...
          {step === 2 && (
            <>
              <h2 style={{ color: '#1a2734', fontSize: 26, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 20 }}>{t('form.step2')}</h2>
                ...
                {URGENCY_OPTIONS.map(({ urgency: u, key, color, bg }) => {
                  ...
                  return (
                    <button key={u} onClick={() => setUrgency(u)} style={{
                      ...
                      fontSize: 15, fontWeight: sel ? 600 : 500, cursor: 'pointer',
          ...
          {step === 3 && (
            <>
              <h2 style={{ color: '#1a2734', fontSize: 26, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 20 }}>{t('form.step3')}</h2>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 24, marginTop: 32 }}>
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: 56, fontWeight: 600, color: '#1a2734', lineHeight: 1 }}>{people}</div>
          ...
          {step === 4 && (
            <>
              <h2 style={{ color: '#1a2734', fontSize: 26, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 16 }}>{t('form.step4')}</h2>
              <textarea
                ref={noteRef}
                value={note}
                ...
                style={{
                  ...
                  color: '#1a2734', fontSize: 15, resize: 'vertical', outline: 'none',
                  fontFamily: 'inherit', boxSizing: 'border-box', lineHeight: 1.5,
                }}
              />
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 8 }}>
                <button onClick={handleVoice} style={{
                  fontSize: 13, padding: '8px 14px', borderRadius: 10, cursor: 'pointer', fontWeight: 500,
                ...
                <span style={{ fontSize: 12, color: '#9ca3af' }}>{note.length}/280</span>
              </div>
            </>
          )}
          ...
          {step === 5 && (
            <>
              <h2 style={{ color: '#1a2734', fontSize: 26, fontWeight: 600, letterSpacing: '-0.02em', marginBottom: 20 }}>{t('form.step5')}</h2>
              ...
              <label style={{
                ...
                <span style={{ color: '#1a2734', fontSize: 15, fontWeight: 500 }}>
                  {t('form.location_toggle')}
                </span>
              </label>

              {location && (
                <div style={{ fontSize: 13, color: '#3d8b85', marginBottom: 12, fontWeight: 500 }}>
                  📍 {location.lat}, {location.lng} (approximate)
                </div>
              )}

              <div style={{ marginBottom: 12 }}>
                <div style={{ color: '#6b7280', fontSize: 13, marginBottom: 6, fontWeight: 500 }}>{t('form.city_select')}</div>
                <select
                  value={cityId}
                  ...
                  style={{
                    ...
                    background: 'rgba(255,255,255,0.7)', border: '1px solid rgba(0,0,0,0.1)',
                    color: '#1a2734', fontSize: 15, outline: 'none', fontWeight: 500,
                  }}
                >
